...
**Contract — the boundary between two components, asserted from both sides.** Answers: do these two still agree about the shape they exchange, without running both. Cannot answer: anything about behaviour beyond the shape.
